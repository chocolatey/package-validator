...
@"Directly importing the Chocolatey PowerShell Module is not allowed in automation scripts. Please remove it. This can flag also based on the use of the word 'chocolateyInstaller.psm1' in comments. [More...](https://docs.chocolatey.org/en-us/community-repository/moderation/package-validator/rules/cpmr0011)";
        }
        }
