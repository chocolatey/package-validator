...
namespace chocolatey.package.validator.tests.infrastructure.app
{
    ...
    /// </summary>
    public class when_inspecting_package_with_project_url_that_uses_Akamai : ProjectUrlShouldBeValidRequirementSpecs
    {
        private PackageValidationOutput result;
        ...
        public override void Context()
        {
            ...
            // mailto url shouldn't be allowed
            package.Setup(p => p.ProjectUrl).Returns(new Uri("https://www.dell.com/support/article/en-au/sln311129/dell-command-update?lang=en"));
        }
    ...
    /// </summary>
    public class when_inspecting_package_with_project_url_that_requires_additional_security_headers : ProjectUrlShouldBeValidRequirementSpecs
    {
        private PackageValidationOutput result;
        ...
        public override void Context()
        {
            ...
            // mailto url shouldn't be allowed
            package.Setup(p => p.ProjectUrl).Returns(new Uri("https://faq.whatsapp.com/"));
        }
    ...
    /// </summary>
    public class when_inspecting_package_with_project_url_that_uses_cloudflare_security_features : ProjectUrlShouldBeValidRequirementSpecs
    {
        private PackageValidationOutput result;
        ...
        public override void Context()
        {
            ...
            // mailto url shouldn't be allowed
            package.Setup(p => p.ProjectUrl).Returns(new Uri("https://www.audacityteam.org/help/documentation"));
        }
    ...
    /// </summary>
    public class when_inspecting_package_with_project_url_that_uses_additional_ciphers : ProjectUrlShouldBeValidRequirementSpecs
    {
        private PackageValidationOutput result;
        ...
        public override void Context()
        {
            ...
            // mailto url shouldn't be allowed
            package.Setup(p => p.ProjectUrl).Returns(new Uri("https://www.elster.de/elsterweb/lizenzvertrag/lizenzvertrag_elsterformular"));
        }
    ...
    /// </summary>
    public class when_inspecting_package_with_project_url_that_uses_Akamai_with_operation_timeout : ProjectUrlShouldBeValidRequirementSpecs
    {
        private PackageValidationOutput result;
        ...
        public override void Context()
        {
            ...
            // mailto url shouldn't be allowed
            package.Setup(p => p.ProjectUrl).Returns(new Uri("https://www.amd.com/en/products/chipsets-am4"));
        }
