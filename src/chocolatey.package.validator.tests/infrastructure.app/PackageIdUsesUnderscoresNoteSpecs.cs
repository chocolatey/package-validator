...
namespace chocolatey.package.validator.tests.infrastructure.app
{
    ...
    public abstract class PackageIdUsesUnderscoresNoteSpecsBase : TinySpec
    {
        protected PackageIdUsesUnderscoresNote note;
        protected Mock<IPackage> package = new Mock<IPackage>();

        public override void Context()
        {
            note = new PackageIdUsesUnderscoresNote();
        }

        public class when_inspecting_package_with_underscore_in_id : PackageIdUsesUnderscoresNoteSpecsBase
        {
            ...
            public override void Context()
            {
                ...
                package.Setup(p => p.Id).Returns("package_A");
            }
        ...
        public class when_inspecting_package_without_underscore_in_id : PackageIdUsesUnderscoresNoteSpecsBase
        {
            private PackageValidationOutput result;
